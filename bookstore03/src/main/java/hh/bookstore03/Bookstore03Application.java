...
public class Bookstore03Application {
	
	private static final Logger log = LoggerFactory.getLogger(Bookstore03Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore03Application.class, args);
	}
