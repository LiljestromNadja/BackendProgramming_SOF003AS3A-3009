...
import hh.bookstore05.domain.Category;
import hh.bookstore05.domain.CategoryRepository;

@SpringBootApplication
public class Bookstore05Application {
	
	private static final Logger log = LoggerFactory.getLogger(Bookstore05Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore05Application.class, args);
	}
