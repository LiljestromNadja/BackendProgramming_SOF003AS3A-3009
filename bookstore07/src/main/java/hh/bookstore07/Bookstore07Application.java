...
/*
import hh.bookstore07.domain.ApplicationUser;
...
import hh.bookstore07.domain.Category;
import hh.bookstore07.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore07Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore07Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore07Application.class, args);
