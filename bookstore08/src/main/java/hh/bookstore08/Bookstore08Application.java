...
/*
import hh.bookstore08.domain.ApplicationUser;
import hh.bookstore08.domain.ApplicationUserRepository;
import hh.bookstore08.domain.Book;
import hh.bookstore08.domain.BookRepository;
import hh.bookstore08.domain.Category;
import hh.bookstore08.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore08Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore08Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore08Application.class, args);
