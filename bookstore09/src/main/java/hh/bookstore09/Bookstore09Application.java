...
/*
import hh.bookstore09.domain.ApplicationUser;
import hh.bookstore09.domain.ApplicationUserRepository;
import hh.bookstore09.domain.Book;
import hh.bookstore09.domain.BookRepository;
import hh.bookstore09.domain.Category;
import hh.bookstore09.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore09Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore09Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore09Application.class, args);
