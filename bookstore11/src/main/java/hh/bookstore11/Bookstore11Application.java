...
/*
import hh.bookstore11.domain.ApplicationUser;
import hh.bookstore11.domain.ApplicationUserRepository;
import hh.bookstore11.domain.Book;
import hh.bookstore11.domain.BookRepository;
import hh.bookstore11.domain.Category;
import hh.bookstore11.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore11Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore11Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore11Application.class, args);
