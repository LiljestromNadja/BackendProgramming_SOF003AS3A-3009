...
/*
import hh.bookstore12.domain.ApplicationUser;
...
import hh.bookstore12.domain.Category;
import hh.bookstore12.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore12Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore12Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore12Application.class, args);
