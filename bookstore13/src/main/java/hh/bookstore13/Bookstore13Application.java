...
/*
import hh.bookstore13.domain.ApplicationUser;
import hh.bookstore13.domain.ApplicationUserRepository;
import hh.bookstore13.domain.Book;
import hh.bookstore13.domain.BookRepository;
import hh.bookstore13.domain.Category;
import hh.bookstore13.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore13Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore13Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore13Application.class, args);
