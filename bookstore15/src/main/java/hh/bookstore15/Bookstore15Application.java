...
/*
import hh.bookstore15.domain.ApplicationUser;
import hh.bookstore15.domain.ApplicationUserRepository;
import hh.bookstore15.domain.Book;
import hh.bookstore15.domain.BookRepository;
import hh.bookstore15.domain.Category;
import hh.bookstore15.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore15Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore15Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore15Application.class, args);
		...
		System.out.println("Versio 15 (02-11-2023)");
		System.out.println("- nimetty RestBookController -> RestBookStoreController");
		System.out.println("- muokattu WebSecurityConfig.java");
