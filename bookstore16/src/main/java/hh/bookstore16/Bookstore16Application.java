...
/*
import hh.bookstore16.domain.ApplicationUser;
import hh.bookstore16.domain.ApplicationUserRepository;
import hh.bookstore16.domain.Book;
import hh.bookstore16.domain.BookRepository;
import hh.bookstore16.domain.Category;
import hh.bookstore16.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore16Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore16Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore16Application.class, args);
		...
		System.out.println("Versio 16 (06-11-2023)");
		System.out.println("- Korjattu kommenttien lisäys listasta valitusta kirjasta (chooseAndAddComment");
		System.out.println("- Poistettu mahdollisuus lisätä tyhjiä kommentteja");
