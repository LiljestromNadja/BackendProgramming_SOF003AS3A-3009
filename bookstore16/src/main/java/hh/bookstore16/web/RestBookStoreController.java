...
import hh.bookstore16.domain.Comment;
import hh.bookstore16.domain.CommentRepository;
...
public class RestBookStoreController {
	...
	// Palautetaan kommentti id:n perusteella GET http://localhost:8080/commentsjson/1
