...
/*
import hh.bookstore17.domain.ApplicationUser;
...
import hh.bookstore17.domain.Category;
import hh.bookstore17.domain.CategoryRepository; */

@SpringBootApplication
public class Bookstore17Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Bookstore17Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Bookstore17Application.class, args);
		...
		System.out.println("Versio 17 (06-11-2023)");
		System.out.println("- Kommentteihin vastaaminen lisätty");
