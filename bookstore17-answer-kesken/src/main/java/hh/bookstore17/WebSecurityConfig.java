...
import hh.bookstore17.web.UserDetailServiceImpl;
...
public class WebSecurityConfig {
    ...
    private static final AntPathRequestMatcher[] WHITE_LIST_URLS = {
            ...
            new AntPathRequestMatcher("/answersjson/**") //api 6.11
    };
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		.and()
		.formLogin().defaultSuccessUrl("/index", true) //.formLogin().defaultSuccessUrl("/booklist", true)
		.and()
		.logout().permitAll();
